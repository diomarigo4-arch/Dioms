...
export const defSets = {
  ...
  nameid: 'ೃ࿔ Nazis ωαɓσƭร - σƒƒเ૮เαℓ ૮ɦαɳɳεℓ .ೃ࿐',
  type: 'Owner',
  link: 'https://api.yuki-wabot.my.id',
  banner: 'https://cdn.phototourl.com/free/2026-08-01-372270ea-f247-46da-bd07-6ad2b2130c75.jpg',
  icon: 'https://cdn.phototourl.com/free/2026-08-01-372270ea-f247-46da-bd07-6ad2b2130c75.jpg',
  currency: 'Yenes',
  namebot: 'Nazis',
  botname: 'Nazis Bot',
  owner: ''
...
export function initDB() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      nameid TEXT DEFAULT 'ೃ࿔ Nazis ωαɓσƭร - σƒƒเ૮เαℓ ૮ɦαɳɳεℓ .ೃ࿐',
      type TEXT DEFAULT 'Owner',
      link TEXT DEFAULT 'https://api.nazis-wabot.my.id',
      banner TEXT DEFAULT 'https://cdn.phototourl.com/free/2026-08-01-372270ea-f247-46da-bd07-6ad2b2130c75.jpg',
      icon TEXT DEFAULT 'https://cdn.phototourl.com/free/2026-08-01-372270ea-f247-46da-bd07-6ad2b2130c75.jpg',
      currency TEXT DEFAULT 'Yenes',
      namebot TEXT DEFAULT 'Nazis',
      botname TEXT DEFAULT 'Nazis Bot ',
      owner TEXT DEFAULT ''
    )`);
